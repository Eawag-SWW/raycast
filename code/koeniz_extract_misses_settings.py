...
detection = {
    ...
    "trained_cluster_classifier": "Q:/Abteilungsprojekte/eng/SWWData/Matthew/PhD_DATA/side_2016_raycast/analysis/Logistic models/32px/7N/s11__fit_binary_model\logistic_regression.pkl",
...
training_images = {
    'width': 32,
    'height': 32,
    "positives_file": "Q:/Abteilungsprojekte/eng/SWWData/Matthew/PhD_DATA/side_2016_raycast/analysis/Detection/Koeniz/multi-view/32px 1N misses.csv",
    "negatives_file": "Q:/Abteilungsprojekte/eng/SWWData/Matthew/PhD_DATA/side_2016_raycast/analysis/Detection/Koeniz/multi-view/32px 1N misses.csv",
    "csv_delimiter": ","
}
haarClassiferArgs = {
    'numStages': 15,
